    ...
    return (
        <Card className='flex flex-col justify-center gap-6 p-8'>
            ...
            <p className='leading-relaxed max-md:hidden'>
                Si tienes un proyecto que quieres iniciar, crees que necesito ayudarte con algo o simplemente quieres saludar, ponte en contacto.
            </p>
            <div className='inline-flex flex-col items-center gap-6 lg:flex-row'>
                <a
                    ...
                    href='mailto:itsjosepablosg@gmail.com'>
